...
def find_all_links(text: str, with_text: bool, default_scheme: str, schemes: Tuple[str, ...]
...
class cachedproperty(object):
    ...
    def __get__(self, obj: URL, objtype: type) -> QueryParamDict: ...
...
class URL(object):
    ...
    @classmethod
    def from_parts(cls, scheme: str, host: str,
    ...
    def __ne__(self, other: URL) -> bool: ...
...
def parse_qsl(qs: str, keep_blank_values: bool, encoding: str
